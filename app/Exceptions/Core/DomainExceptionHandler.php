...
use App\Exceptions\Access\{
    AccessException,
    UnauthorizedAccessException,
    CacheException,
    BulkAccessOperationException,
    SyncException
};
...
use App\Exceptions\Permissions\{
    ...
    InvalidPermissionDataException,
    SystemPermissionException,
    PermissionDeletionException,
    PermissionAssignmentException,
    PermissionGroupException,
    PermissionDependencyException,
