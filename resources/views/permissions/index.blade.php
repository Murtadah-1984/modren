                        ...
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                ...
                                @can('forceDelete_permissions')
                                    <button type="button" class="btn btn-danger" onclick="massForceDelete('Permission')"><i class="fas fa-trash"></i></button>
                                @endcan
                                @can('delete_permissions')
                                    <button type="button" class="btn btn-outline-danger" onclick="massDestroy('Permission')"><i class="fas fa-trash"></i></button>
                                @endcan
                                @can('restore_permissions')
                                    <button type="button" class="btn btn-outline-success" onclick="massRestore('Permission')"><i class="fas fa-trash-restore"></i></button>
                                @endcan
                                @can('add_permissions')
...
@section('scripts')
    ...
    <script type="text/javascript">
        ...
        const table = $('#dataTable').DataTable({responsive: true, serverSide: true, processing: true, pageLength: 10, stateSave: true, colReorder: true, fixedColumns: true, fixedHeader: true, select: true, dom: 'lBfrtip',order: [[1, 'asc']],
            lengthMenu: [[10, 25, 50, 100], [10, 25, 50, 100],], buttons: [@can('export_permissions')'copyHtml5','excelHtml5','pdfHtml5','print'@endcan],
            ...
            columns: [
                ...
                {data: 'roles', name: 'roles.display_name', render: '[ , ].display_name', className: 'text-center align-middle', orderable: false},
